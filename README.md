...
| 4 |☑ Все ссылки на сайте переходят на соответствующие страницы.  |
| 5 |☑ Отсутствуют битые ссылки.                                  |
| 6 |☑ Производится проверка всех веб-форм на сайте.              |
| 7 |☑ Обязательные поля в формах успешно проходят валидацию.     |
| 8 |☑ Обязательные поля помечены символом «*».                   |
| 9 |☑ Необязательные поля также проходят валидацию.              |
|10 |☑ Основные элементы сайта функционируют без нарушений.       |
|11 |☑ Навигационное меню работает корректно.                    |
|12 |☑ Загружаемые документы открываются правильно.              |
|13 |☑ Отправка форм происходит без ошибок.                      |
|14 |☑ Поведение сайта при удалении cookies проверяется.         |
|15 |☑ Реакция сайта на удаление cookies после посещения также тестируется.|
|16 |☑ Все данные в списках располагаются хронологически.         |

## Чек-лист тестирования вёрстки
| № | Пункт проверки                                              |
|---|-------------------------------------------------------------|
| 1 |☑ Используется кодировка UTF-8.                              |
| 2 |☑ Шрифты успешно загружаются и отображаются.                 |
| 3 |☑ Ошибок HTML и CSS не обнаружено.                           |
| 4 |☑ Элементы веб-страниц корректно отображаются на разных разрешениях экранов.|
| 5 |☑ Функциональность кнопок подтверждена на различных страницах.|
| 6 |☑ Верстка форм подстраивается при изменении размеров окна.  |
| 7 |☑ Вёрстка адаптирована для разных веб-браузеров.             |
| 8 |☑ В коде отсутствуют многочисленные комментарии.             |
| 9 |☑ Сайт обладает favicon.                                     |
| 9 |☑ Шрифт по макету, размер, цвет, размер кнопки, прозрачночть.|
| 9 |☑ Анимация при наведени курсора на кнопку.                   | 
| 9 |☑ Элементы(не хватает), их тени, расстояние между элементами |

## Чек-лист Smoke-тестирования
| № | Пункт проверки                                              |
|---|-------------------------------------------------------------|
| 1 |☑ Сайт успешно открывается и доступен.                       |
| 2 |☑ Основные компоненты веб-ресурса функционируют без сбоев.  |
| 3 |☑ Консоль не содержит ошибок.                                |
| 4 |☑ Битых ссылок на сайте не обнаружено.                      |
| 5 |☑ Важные страницы сайта доступны и функциональны.            |
| 6 |☑ На главной странице не видно заметных ошибок.             |

## Чек-лист тестирования формы регистрации (входа, пароля)
| № | Пункт проверки                                              |
|---|-------------------------------------------------------------|
| 1 |☑ Возможность заполнения полей формы подтверждена.           |
| 2 |☑ После нажатия кнопки «Отправить» данные успешно передаются.|
| 3 |☑ Письмо после регистрации отправляется на указанный адрес электронной почты.|
| 4 |☑ Введённые данные корректно передаются в запросе.          |
| 5 |☑ Валидация обязательных полей проходит успешно.            |
| 6 |☑ Необязательные поля также проходят валидацию.             |
